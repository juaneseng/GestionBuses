class Empresa:
    ...
    def asignar_ruta(self):
        while True:
            ...
            pasajeros = input("Ingrese el número total de pasajeros: ")
            menores = input("Ingrese el número de pasajeros menores de edad: ")
            menores_femenino = input("Ingrese el número de menores de edad de género femenino: ")
...
if placa_max:
    print(f"2. Buseta intermunicipal que más recaudó: {placa_max} (${rec_max})")
else:
